...
_NORMAL_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            "cc": Label("@crates.io//:cc-1.2.20"),
            "clap": Label("@crates.io//:clap-4.5.37"),
            "codespan-reporting": Label("@crates.io//:codespan-reporting-0.12.0"),
            "foldhash": Label("@crates.io//:foldhash-0.1.4"),
...
_PROC_MACRO_DEPENDENCIES = {
    "": {
        _COMMON_CONDITION: {
            "rustversion": Label("@crates.io//:rustversion-1.0.20"),
        },
    },
}
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "crates.io__anstyle-1.0.10",
    ...
    maybe(
        ...
        build_file = Label("//deps/rust/crates:BUILD.cc-1.2.20.bazel"),
    )

    maybe(
        http_archive,
        name = "crates.io__clap-4.5.37",
        ...
        build_file = Label("//deps/rust/crates:BUILD.clap-4.5.37.bazel"),
    )

    maybe(
        http_archive,
        name = "crates.io__clap_builder-4.5.37",
        ...
        build_file = Label("//deps/rust/crates:BUILD.clap_builder-4.5.37.bazel"),
    )

    maybe(
        http_archive,
        name = "crates.io__clap_derive-4.5.32",
    ...
    maybe(
        http_archive,
        name = "crates.io__clap_lex-0.7.4",
    ...
    maybe(
        http_archive,
        name = "crates.io__codespan-reporting-0.12.0",
    ...
    maybe(
        http_archive,
        name = "crates.io__foldhash-0.1.4",
        ...
        build_file = Label("//deps/rust/crates:BUILD.foldhash-0.1.4.bazel"),
    )

    maybe(
        http_archive,
        name = "crates.io__heck-0.5.0",
    ...
    maybe(
        http_archive,
        name = "crates.io__proc-macro2-1.0.94",
        ...
        build_file = Label("//deps/rust/crates:BUILD.proc-macro2-1.0.94.bazel"),
    )

    maybe(
        http_archive,
        name = "crates.io__quote-1.0.39",
        ...
        build_file = Label("//deps/rust/crates:BUILD.quote-1.0.39.bazel"),
    )

    maybe(
        http_archive,
        name = "crates.io__rustversion-1.0.20",
    ...
    maybe(
        http_archive,
        name = "crates.io__serde_derive-1.0.219",
    ...
    maybe(
        ...
        build_file = Label("//deps/rust/crates:BUILD.syn-2.0.100.bazel"),
    )

    maybe(
        http_archive,
        name = "crates.io__termcolor-1.4.1",
    ...
    maybe(
        http_archive,
        name = "crates.io__unicode-ident-1.0.11",
        ...
        build_file = Label("//deps/rust/crates:BUILD.unicode-ident-1.0.11.bazel"),
    )

    maybe(
        http_archive,
        name = "crates.io__unicode-width-0.2.0",
    ...
    maybe(
        http_archive,
        name = "crates.io__winapi-util-0.1.9",
    ...
    maybe(
        http_archive,
        name = "crates.io__windows-sys-0.59.0",
    ...
    maybe(
        http_archive,
        name = "crates.io__windows-targets-0.52.6",
    ...
    maybe(
        http_archive,
        name = "crates.io__windows_aarch64_gnullvm-0.52.6",
    ...
    maybe(
        http_archive,
        name = "crates.io__windows_aarch64_msvc-0.52.6",
    ...
    maybe(
        http_archive,
        name = "crates.io__windows_i686_gnu-0.52.6",
    ...
    maybe(
        http_archive,
        name = "crates.io__windows_i686_gnullvm-0.52.6",
    ...
    maybe(
        http_archive,
        name = "crates.io__windows_i686_msvc-0.52.6",
    ...
    maybe(
        http_archive,
        name = "crates.io__windows_x86_64_gnu-0.52.6",
    ...
    maybe(
        http_archive,
        name = "crates.io__windows_x86_64_gnullvm-0.52.6",
    ...
    maybe(
        http_archive,
        name = "crates.io__windows_x86_64_msvc-0.52.6",
    ...
    return [
        struct(repo = "crates.io__cc-1.2.20", is_dev_dep = False),
        struct(repo = "crates.io__clap-4.5.37", is_dev_dep = False),
        struct(repo = "crates.io__codespan-reporting-0.12.0", is_dev_dep = False),
        struct(repo = "crates.io__foldhash-0.1.4", is_dev_dep = False),
        struct(repo = "crates.io__proc-macro2-1.0.94", is_dev_dep = False),
